...
func GetHTMLTitle(c *colly.Collector, url string) {
	...
	// product scraping
	c.OnHTML("div.s-card-container s-overflow-hidden aok-relative puis-expand-height puis-include-content-margin puis s-latency-cf-section s-card-border", func(e *colly.HTMLElement) {
		name := e.DOM.Text()
